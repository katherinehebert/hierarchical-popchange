...
saveRDS(mod1, paste0("outputs/testing/gam_02_onlylatents.rds")) 

# Plot latent factors ----------------------------------------------------------

png("outputs/testing/fig_gam_02_onlylatents_latentfactors.png", height=1000, width=1800, type = "cairo",pointsize = 20)
mvgam::plot_mvgam_factors(mod1)
dev.off()

# Plot the random effect on species --------------------------------------------

png("outputs/testing/fig_gam_02_onlylatents_randomeffect.png", height=1000, width=1800, type = "cairo",pointsize = 20)
...
saveRDS(preds, "outputs/testing/gam_02_onlylatents_predictions.rds")
saveRDS(derivs, "outputs/testing/gam_02_onlylatents_derivatives.rds")
...
saveRDS(derivs_pops_df, "outputs/testing/gam_02_onlylatents_derivs_pops_df.rds")
...
saveRDS(avg_deriv_trend, "outputs/testing/gam_02_onlylatents_df_overall_deriv.rds")
...
saveRDS(temporal_trend_yearly, "outputs/testing/gam_02_onlylatents_temporal_trend_yearly.rds")
...
ggsave("outputs/testing/fig_02_onlylatents_assemblagevariability.png", width = 7, height = 3)
