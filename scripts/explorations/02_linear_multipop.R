...
m <- hmsc(formDat,
          ...
          verbose = FALSE)
# save model
saveRDS(m, "outputs/linear_multipop.RDS")
...
coefs$varX#[2,2] # community's variance (temporal trends) what is this???????
...
plot(overall_pred$overall_mu, type = "l", ylim = c(-1, 3), lwd = 2)
...
# and no species associations are available from this model!